<template>
    <v-container fluid>
      <v-card class="mb-3">
        ...
        <template v-else>
          <v-card-subtitle>Table Detail</v-card-subtitle>
        </template>
      </v-card>
      <v-card>
        <v-card-subtitle>
          ...
          >
          <v-btn class="ma-1" color="warning" :to="{ name: 'table.edit' }"
            ><v-icon left>mdi-pencil-box-outline</v-icon>Edit table</v-btn
          >
        </v-card-subtitle>
